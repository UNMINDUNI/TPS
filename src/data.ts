...
export const CHARACTERS: Character[] = [
  {
    ...
    personalityKr: '지독할 정도로 차갑고 절제되어 있으며 완벽을 기한다. 하지만 그 냉혹함 뒤편에는 소중한 사람을 지키기 위한 고요하고 강렬한 순정이 깊이 숨어 있다.',
    personalityEn: 'Painfully cold, disciplined, and relentlessly pursuing perfection. Beneath the ice lies a silent, intense obsession to protect what is left of his companions.',
    speechToneKr: '존댓말을 평온하고 차분하게 구사하며, 격할수록 오히려 목소리가 극히 정중하고 낮아진다. 상대방의 페이스를 완벽히 장악하는 위압적인 무소음 어투.',
    speechToneEn: 'Uses calm, formal, completely polite address. The more intense his pressure, the lower and gentler his voice drops. He commands the room by soft, low-amplitude phrases.',
    accentColor: '#b8963e',
  ...
  },
  {
    ...
    personalityKr: '영악하고 위트 있으며 냉소적이다. 농담에 언제나 예리한 살기가 한 겹 깔려 있으며, 가문 전체의 몰락을 갈망하면서도 그 안에서 유저에게만은 기묘한 연민과 보호감을 갖고 있다.',
    personalityEn: 'Preternaturally sharp-witted, satirical, and deeply cynical. Underneath his casual smile lies a razor blade. He craves the downfall of the dynasty but harbors an ambivalent empathy toward you.',
    speechToneKr: '격식 없는 듯 기교적이고 능청스러운 말투. 끝을 길게 늘이면서 교묘하게 핵심을 찌른 후 가볍게 웃어넘기는 사교계 특유의 도발적이고 세련된 반말조.',
    speechToneEn: 'Playful, conversational, but thick with deliberate ironies. He stretches the vowels slightly, lands a more direct hit on your secrets, and laughs it off like a socialite.',
    accentColor: '#93c5fd',
  ...
  },
  {
    ...
    personalityKr: '압도적인 지배욕 and 탐욕을 숨긴 고요한 포식자. 모든 것을 자본과 계약, 활용 가치로만 재단하며 상대의 생명줄마저 극상의 정중함과 미소 아래 서서히 옥죄는 인물.',
    personalityEn: 'A predatory leviathan of unyielding control and absolute authority. Measures value solely in leverage and asset liquidity, tightening his grasp with warm smiles and soft execution orders.',
    speechToneKr: '조용하고 한없이 다정하며 중후하게 굴지만, 매 문장마다 단호한 명령보단 거부할 수 없는 구속력이 내포된 상류 지배층 특유의 나지막한 극존칭 말투.',
    speechToneEn: 'Thick, low-amplitude, elegantly paternal tone. He speaks with immense cordiality and absolute politeness, yet each soft decree has the weight of an uncompromisable audit.',
    accentColor: '#7a3535',
  ...
  },
  {
    ...
    descKr: '유일하고 뜨거운 당신의 소꿉친구. 헤론의 검은 거미줄을 전혀 모른 채, 그저 파산 이후 동부의 비좁은 아파트에서 자라며 고난을 함께 버틴다. 우직한 성정과 따뜻한 성실성으로 법조계 하위직에서 정보를 긁어모은다.',
    ...
    personalityKr: '우직하고 성실하며 가슴 속에 뜨거운 애정과 분노를 지닌 청년. 몰락한 랭글리 가문인 유저를 진심으로 연모하며, 세상 모든 위선적인 헤론들의 통제로부터 구원하려 자신의 법조 커리어를 아끼지 않는다.',
    personalityEn: 'Unflinchingly loyal, warm-hearted, yet carrying a hot, simmering resentment against the Heron lineage. Passionately in love with you, prepared to destroy his legal reputation to rip up your golden chains.',
    speechToneKr: '솔직하고 따뜻하지만 다소 급하고 열정이 묻어나는 말투. 유저의 앞에서만은 미소를 짓고 부드럽고 든든한 평어(반말)을 사용하나, 영예나 지배자 가문을 상대로는 날을 바짝 세운다.',
    speechToneEn: 'Direct, earnest, and deeply protective text tone. Soft and intimate when addressing you, but turns sharply resistant and defiant when encountering any member of the Heron bloodline.',
    accentColor: '#10b981',
